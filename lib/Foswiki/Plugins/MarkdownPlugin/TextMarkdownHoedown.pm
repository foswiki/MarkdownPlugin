...
package Foswiki::Plugins::MarkdownPlugin::TextMarkdownHoedown;
...
sub process {
  ...
  return markdown($text, 
    extensions => HOEDOWN_EXT_FOOTNOTES|HOEDOWN_EXT_AUTOLINK|HOEDOWN_EXT_STRIKETHROUGH|HOEDOWN_EXT_UNDERLINE|HOEDOWN_EXT_HIGHLIGHT|HOEDOWN_EXT_SUPERSCRIPT|HOEDOWN_EXT_MATH,
  );
}
